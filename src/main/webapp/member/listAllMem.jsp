...
<table class="ta">
    ...
    <div class="member-container">
        ...
        <c:forEach var="memVO" items="${list}" begin="<%=pageIndex%>" end="<%=pageIndex+rowsPerPage-1%>">
            ...
            <%--                        <img src="${pageContext.request.contextPath}/memIconReader?memNo=${memVO.memNo}" width="50"--%>
            <%--                             height="50"/>--%>
            <%--                    </c:otherwise>--%>
            <%--                </c:choose>--%>
            <%--            </td>--%>
            ...
            <div class="card">
                ...
                <div class="card-item">會員編號: ${memVO.memNo}</div>
                <div class="card-item">會員姓名: ${memVO.memName}</div>
                <div class="card-item">會員暱稱: ${memVO.memNickName}</div>
                <div class="card-item">會員帳號: ${memVO.memAccount}</div>
                <div class="card-item">會員密碼: ${memVO.memPassword}</div>
                <div class="card-item">會員Email: ${memVO.memEmail}</div>
                <div class="card-item">會員電話: ${memVO.memPhone}</div>
                <div class="card-item">會員生日日期: ${memVO.memBirthday}</div>
                <div class="card-item">會員狀態: ${memVO.memStatus}</div>
                <div class="card-item">會員Token: ${memVO.memToken}</div>
                <div class="card-item">會員Email認證代碼: ${memVO.memEmailAuth}</div>
                <div class="card-item">可否發文: ${memVO.canPost}</div>
                <div class="card-item">可否留言: ${memVO.canComment}</div>
                <div class="card-item">可否買二手物品: ${memVO.canUsedPro}</div>
                <div class="card-item">會員認證狀態: ${memVO.authenticated}</div>
                <div class="card-item">會員積分: ${memVO.point}</div>
